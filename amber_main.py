...
def tracking():
    ...
    # Report the overall accuracy
    errors = np.vstack(errors)
    labels = ["tracked_point_x", " tracked_point_y", "shaft_axis_angle", "head_axis_angle"] #, "clasper_angle"] # TODO: Uncomment if you'd like to try with clasper_angle
    make_histograms(errors, labels, xlim=None, n_bins=20, \
        ylabel = ["Frames", "Frames", "Frames", "Frames"], \
        xlabel=["Error [Pixels]", "Error [Pixels]", "Error [Degrees]", "Error [Degrees]"])
